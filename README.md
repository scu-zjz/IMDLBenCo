...
- [2026/08/28] **Blog**: [分久必合：统一的伪造图像检测（Unified FID）](https://knightzjz.github.io/blog/unified-fid.html) / [Long Divided, Shall Unite](https://knightzjz.github.io/blog/unified-fid-en.html) — an introduction to the Unified Fake Image Detection task and the discussion on why this task matters, and where the field is heading.
...
- [RelayFormer](https://arxiv.org/abs/2508.09459): A study on image–video interaction in unified forgery localization under multiple training configurations, investigating how image and video data jointly affect manipulation localization performance, and proposing RelayFormer, a GLR-token-based framework for efficient unified image–video manipulation localization. **ICLR'26.** [![Stars](https://img.shields.io/github/stars/WenOOI/RelayFormer)](https://github.com/WenOOI/RelayFormer)
- [DINOv3-IML](https://arxiv.org/abs/2604.16083): A SoTA IML model implemented with DINOv3, which considered as a strong baseline or backbone for IMDL task. Arxiv.  [![Stars](https://img.shields.io/github/stars/Irennnne/DINOv3-IML)](https://github.com/Irennnne/DINOv3-IML)
- [Co-Transformers](https://ojs.aaai.org/index.php/AAAI/article/view/38250): A dual-Transformer framework with multi-level forensic attention for image manipulation localization, collaboratively modeling semantic inconsistencies and forensic traces for accurate pixel-level tampered region localization. **AAAI'26.** [![Stars](https://img.shields.io/github/stars/ProgrameThinking/Co-Transformers?style=social)](https://github.com/ProgrameThinking/Co-Transformers)
- [BR-Gen & NFA-ViT](https://arxiv.org/abs/2504.11922): A Novel Dataset for Localized AI-Generated Image Detection with Forgery Amplification Approach and a corresponding noise-guided forgery amplification transformer as a solution method. **AAAI'26.** [![GitHub Repo stars](https://img.shields.io/github/stars/clpbc/BR-Gen)](https://github.com/clpbc/BR-Gen)
- [ForensicHub](https://arxiv.org/abs/2505.11003): A code base for all-domain fake image detection, including 1) Anti-AIGC, 2) Deepfake, 3) IMDL, and 4) Document image manipulation detection. **NeurIPS'25.** [![GitHub Repo stars](https://img.shields.io/github/stars/scu-zjz/ForensicHub)](https://github.com/scu-zjz/ForensicHub)
